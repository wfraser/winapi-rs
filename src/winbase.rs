...
pub const WAIT_OBJECT_0: ::DWORD = ::STATUS_WAIT_0 + 0;
pub const WAIT_ABANDONED: ::DWORD = ::STATUS_ABANDONED_WAIT_0 + 0;
pub const WAIT_ABANDONED_0: ::DWORD = ::STATUS_ABANDONED_WAIT_0 + 0;
